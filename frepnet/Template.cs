...
namespace frepnet
{
    class Template
    {
        ...
        private static Template _LoadQ1(Settings settings)
        {
            ...
            if (!File.Exists(fileName)) File.WriteAllText(fileName, DotLiquid.Properties.Resources.Query_1_Default_Template);
        ...
        private static Template _LoadQ2(Settings settings)
        {
            ...
            if (!File.Exists(fileName)) File.WriteAllText(fileName, DotLiquid.Properties.Resources.Query_2_Default_Template);
            Template result = new Template();
            result._Content = File.ReadAllText(fileName);
        ...
        private static Template _LoadQ3(Settings settings)
        {
            ...
            if (!File.Exists(fileName)) File.WriteAllText(fileName, DotLiquid.Properties.Resources.Query_3_Default_Template);
            Template result = new Template();
            result._Content = File.ReadAllText(fileName);
        ...
        private static Template _LoadQ4(Settings settings)
        {
            ...
            if (!File.Exists(fileName)) File.WriteAllText(fileName, DotLiquid.Properties.Resources.Query_4_Default_Template);
            Template result = new Template();
            result._Content = File.ReadAllText(fileName);
        ...
        private static Template _LoadQ5(Settings settings)
        {
            ...
            if (!File.Exists(fileName)) File.WriteAllText(fileName, DotLiquid.Properties.Resources.Query_5_Default_Template);
            Template result = new Template();
            result._Content = File.ReadAllText(fileName);
        ...
        private static Template _LoadQ6(Settings settings)
        {
            ...
            if (!File.Exists(fileName)) File.WriteAllText(fileName, DotLiquid.Properties.Resources.Query_6_Default_Template);
            Template result = new Template();
            result._Content = File.ReadAllText(fileName);
        ...
        private static Template _LoadQ7(Settings settings)
        {
            ...
            if (!File.Exists(fileName)) File.WriteAllText(fileName, DotLiquid.Properties.Resources.Query_7_Default_Template);
            Template result = new Template();
            result._Content = File.ReadAllText(fileName);
        ...
        private static Template _LoadQ8(Settings settings)
        {
            ...
            if (!File.Exists(fileName)) File.WriteAllText(fileName, DotLiquid.Properties.Resources.Query_8_Default_Template);
            Template result = new Template();
            result._Content = File.ReadAllText(fileName);
        ...
        private static Template _LoadQ9(Settings settings)
        {
            ...
            if (!File.Exists(fileName)) File.WriteAllText(fileName, DotLiquid.Properties.Resources.Query_9_Default_Template);
            Template result = new Template();
            result._Content = File.ReadAllText(fileName);
        ...
        private static Template _LoadQ10(Settings settings)
        {
            ...
            if (!File.Exists(fileName)) File.WriteAllText(fileName, DotLiquid.Properties.Resources.Query_10_Default_Template);
            Template result = new Template();
            result._Content = File.ReadAllText(fileName);
        ...
        private static Template _LoadQ11(Settings settings)
        {
            ...
            if (!File.Exists(fileName)) File.WriteAllText(fileName, DotLiquid.Properties.Resources.Query_11_Default_Template);
            Template result = new Template();
            result._Content = File.ReadAllText(fileName);
        ...
        private static Template _LoadQ12(Settings settings)
        {
            ...
            if (!File.Exists(fileName)) File.WriteAllText(fileName, DotLiquid.Properties.Resources.Query_12_Default_Template);
            Template result = new Template();
            result._Content = File.ReadAllText(fileName);
        ...
        private static Template _LoadQ13(Settings settings)
        {
            ...
            if (!File.Exists(fileName)) File.WriteAllText(fileName, DotLiquid.Properties.Resources.Query_13_Default_Template);
            Template result = new Template();
            result._Content = File.ReadAllText(fileName);
        ...
        private static Template _LoadQ14(Settings settings)
        {
            ...
            if (!File.Exists(fileName)) File.WriteAllText(fileName, DotLiquid.Properties.Resources.Query_14_Default_Template);
            Template result = new Template();
            result._Content = File.ReadAllText(fileName);
        ...
        private static Template _LoadQ15(Settings settings)
        {
            ...
            if (!File.Exists(fileName)) File.WriteAllText(fileName, DotLiquid.Properties.Resources.Query_15_Default_Template);
            Template result = new Template();
            result._Content = File.ReadAllText(fileName);
        ...
        private static Template _LoadQ16(Settings settings)
        {
            ...
            if (!File.Exists(fileName)) File.WriteAllText(fileName, DotLiquid.Properties.Resources.Query_16_Default_Template);
            Template result = new Template();
            result._Content = File.ReadAllText(fileName);
        ...
        private static Template _LoadQ17(Settings settings)
        {
            ...
            if (!File.Exists(fileName)) File.WriteAllText(fileName, DotLiquid.Properties.Resources.Query_17_Default_Template);
            Template result = new Template();
            result._Content = File.ReadAllText(fileName);
        ...
        private static Template _LoadQ18(Settings settings)
        {
            ...
            if (!File.Exists(fileName)) File.WriteAllText(fileName, DotLiquid.Properties.Resources.Query_18_Default_Template);
            Template result = new Template();
            result._Content = File.ReadAllText(fileName);
        ...
        private static Template _LoadQ19(Settings settings)
        {
            ...
            if (!File.Exists(fileName)) File.WriteAllText(fileName, DotLiquid.Properties.Resources.Query_19_Default_Template);
            Template result = new Template();
            result._Content = File.ReadAllText(fileName);
        ...
        private static Template _LoadQ20(Settings settings)
        {
            ...
            if (!File.Exists(fileName)) File.WriteAllText(fileName, DotLiquid.Properties.Resources.Query_20_Default_Template);
            Template result = new Template();
            result._Content = File.ReadAllText(fileName);
