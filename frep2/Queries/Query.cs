...
namespace frep2
{
    abstract class Query
    {
        ...
        {
            if (this._Settings.Restrictions[this._QueryType] == null) return true;
            else return this._Settings.Restrictions[this._QueryType].IsConsidered(this._DataBase.Data[id]);
        }
